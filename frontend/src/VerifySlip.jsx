      ...
      <div className="glass-card" style={{ maxWidth: '400px', width: '100%', textAlign: 'center', padding: '40px' }}>
        ...
        {loading ? (
           ...
           <div>
             ...
             <h3 style={{ fontSize: '20px', color: '#ef4444', fontWeight: 'bold' }}>Verification Failed</h3>
           ...
           <div>
             ...
             <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginTop: '20px' }}>
               <div style={{ background: '#e0e7ff', color: '#4338ca', padding: '12px 24px', borderRadius: '8px', fontWeight: 'bold', width: '48%' }}>
                  <span style={{ fontSize: '11px', display: 'block', textTransform: 'uppercase', marginBottom: '4px' }}>Squad</span>
                  {result.squad || 'Unassigned'}
               </div>
               <div style={{ background: '#dcfce7', color: '#15803d', padding: '12px 24px', borderRadius: '8px', fontWeight: 'bold', width: '48%' }}>
